...
const STEP_DESCRIPTIONS = [
  'Upload governance documents, security policies, and organizational charts. This covers risk management strategy and compliance posture.',
  'This step covers identity verification, access controls, and privilege management. Gather evidence from your IAM provider (e.g., Active Directory, Entra ID, Okta, AWS IAM).',
  'This step covers endpoint protection and cloud security posture. Evidence can come from any EDR/XDR solution or cloud security platform (e.g., Defender, CrowdStrike, SentinelOne).',
  'This step covers cloud infrastructure security configuration. Relevant for AWS, Azure, GCP, or any cloud provider you use. Upload security configs, IAM policies, and audit logs.',
  'Provide network diagrams, firewall rules, and segmentation documentation. Applicable to any network infrastructure or SD-WAN solution.',
  'Share endpoint protection configurations and deployment status from your EDR/XDR or antivirus platform.',
  'Upload data classification policies, encryption configurations, and DLP reports. Covers data-at-rest and data-in-transit protection.',
  'Provide access control configurations, role-based access reviews, MFA deployment status, and privilege escalation controls.',
  'Share SIEM configurations, monitoring dashboards, and alert rules from your security monitoring platform (e.g., Splunk, Sentinel, Elastic).',
  'Upload incident response plans, playbooks, tabletop exercise results, and post-incident reports.',
  'Provide backup configurations, recovery plans, and restoration test results. Covers both on-premise and cloud backup strategies.',
  'Share vulnerability scan reports, patch management policies, and remediation tracking from your scanning tools (e.g., Qualys, Nessus, Rapid7).',
  'Upload vendor risk assessments, third-party audit reports, and supply chain security documentation.',
  'Provide security awareness training materials, completion records, and phishing simulation test results.',
